...
/*
  Classe com a função de decifrar as informações do arquivo contendo os logins cifrados, conforme os métodos da classe CryptoRSA
  e assim retornar dois vetores: um contendo os usuários e outro contendo as senhas.
*/
public class Decypher
{
   ...
   public Decypher() throws Exception
   {
      ...
      //Transformando o texto decifrado em três vetores: um contendo somente os usuários, um somente as senhas e outro com apenas os tipos de usuários
      ...
      while( lerString.hasNext() )
      {
         ...
         lerString.skip("/"); //pula o antigo delimitador para este não aparecer na próxima leitura de String
