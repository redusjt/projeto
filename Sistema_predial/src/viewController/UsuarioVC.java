   ...
   */
   ...
   public void actionPerformed(ActionEvent actionE)
   {
      if(actionE.getSource() == bCadastrar)
      {
         ...
         boolean resultado = usuarioService.cadastrarUsuario( cbTipoUsuario.getSelectedIndex(),
                                           tfNome.getText(), 
                                           d, 
                                           tfEndereco.getText(), 
                                           tfBairro.getText(), 
      ...
      if(actionE.getSource() == bSalvar)// só aparece depois de apertado o botão bAlterar
      {
         ...
         //
         UsuarioService usuarioService = new UsuarioService();
         boolean resultado = usuarioService.alterarUsuario( cbTipoUsuario.getSelectedIndex(),
                 tfNome.getText(), 
                 d, 
                 tfEndereco.getText(), 
                 tfBairro.getText(), 
