...
public class AcessoArquivoTexto
{
   ...
   public byte[] lerBytes( String nomeArquivo ) //modo leitura para a classe Decypher. Lê byte por byte conforme indicado na gravação de dados da classe cypher
   {
      abrirArquivoParaLeitura( nomeArquivo );
      
      ArrayList<String> bytesLidos = new ArrayList<String>(1); 
      
      //monta o ArrayList sendo cada posição deste equivalente a um byte lido do arquivo 
      while( lerArquivo.hasNext() )
      {
   ...
   public ArrayList<byte[]> lerLinhasDeBytes( String nomeArquivo ) //modo leitura para a classe Decypher. Lê byte por byte conforme indicado na gravação de dados da classe cypher
   {
      abrirArquivoParaLeitura( nomeArquivo );
      ...
      //monta o ArrayList sendo cada posição deste equivalente a uma linha lida do arquivo 
      while( lerArquivo.hasNext() )
      {
         try{
      ...
      //monta o ArrayList textoCifrado sendo cada posição deste equivalente a um vetor de bytes contido no ArrayList linhasDeBytesLidos 
   ...
   private byte[] lerBytesDeUmaLinha( String linha ) 
   {
      ...
      //monta o ArrayList sendo cada posição deste equivalente a um byte lido da linha 
