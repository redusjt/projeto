...
public class ArCondicionadoDAO {
	...
	private long pesquisarEmpresa(long cpf)// pesquisa o cnpj da empresa do
											// funcionario com o cpf passado
	{
		String sqlSelect = "SELECT usuarioEmpresa FROM projeto.usuario WHERE usuarioCpf = ?";
		PreparedStatement stm = null;
		ResultSet rs = null;
